      ...
      <div className='container'>
        <div className='lg:flex gap-20'>
          <div className='lg:w-3/5'>
            ...
            <p className='text-xl text-text-2/80 tracking-tight mb-6'>Providing technology services to create a strong digital presence for your brand.</p>
            <p className='text-sm text-text-1/80 tracking-tight mb-2'>{`Let's Get Started on Your Dream Project.`}</p>
          ...
          <div className='lg:w-2/5'>
            <Image src={HeroImage} alt='HeroImage' className='mt-20 md:h-70 lg:mt-5' />
          </div>
        </div>
      </div>
    </section>
