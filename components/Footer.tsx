    ...
    <>
        ...
        <div className='container'>
          <div className='md:flex gap-30 justify-between'>
            <div className='flex flex-col items-center gap-1'>
              <Image src={LogoIcon} alt='Logo' height={80} width={80} className='mb-2'/>
              <Image src={LogoText} alt='Logo' height={50} width={240} />
            ...
            <div className='flex flex-col items-center md:items-start gap-4 mt-10'>
              ...
              <Link href={'mailto:contact@nizut.com'} target='_blank' className='text-bg-1/70 hover:text-bg-2 text-lg flex gap-3 items-center'><FaEnvelope className='text-xl' /> contact@nizut.com</Link>
      ...
      <section className='bg-text-2 py-2'>
        <div className='container flex items-center justify-between'>
          <p className='text-bg-2 text-sm md:text-lg'>© 2023 NIZUT | All Rights Reserved.</p>
